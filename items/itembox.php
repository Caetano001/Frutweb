...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="../produtos/produtos.php" class="active">Produtos</a></li>
    ...
    <?php
        ...
        $row=$exib->fetch();
        ?>
        <div class="back" style="width: 80%; margin: auto; margin-bottom: 10px; margin-top: 60px;"><a href="../produtos/produtos.php">VOLTAR</a></div>
        <div class="it1">
