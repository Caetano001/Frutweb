...
<body>
    ...
    <div class="detalcontainer">
        <div class="detalbox1">
            ...
            <div class="detalbox1-1">
                <img src="../../imgs/uva.png" alt="uva">
                <div class="detalinf">
                    <p>Uva Verde 500g R$9,99</p>
                </div>
            </div>
            <div class="detalbox1-1" style="border-bottom: 0;">
                <img src="../../imgs/02-15.png" alt="morango">
                <div class="detalinf">
                    <p>Morango 500g R$9,99</p>
                </div>
            </div>
        </div>
        <div class="detalbox2">
